...
const comboBadge: React.CSSProperties = { position: 'absolute', bottom: 12, right: 12, background: color.gold, color: color.primaryDeep, fontSize: 11.5, fontWeight: 800, padding: '5px 11px', borderRadius: 999, letterSpacing: '0.2px' };
