  ...
  return (
    <main style={{ maxWidth: 560, margin: '0 auto', padding: 'clamp(60px,12vw,120px) 24px', textAlign: 'center', minHeight: '72vh' }}>
      ...
      <div style={{ display: 'flex', gap: 11, justifyContent: 'center', flexWrap: 'wrap' }}>
        <a href="" style={{ background: color.primary, color: '#fff', border: 'none', padding: '14px 26px', borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: 'pointer', fontFamily: font.sans, textDecoration: 'none', display: 'inline-block' }}>Tentar de novo</a>
        <a href="/" style={{ background: '#fff', border: `1.5px solid ${color.lineChip}`, color: color.ink, textDecoration: 'none', padding: '13px 24px', borderRadius: 12, fontSize: 15, fontWeight: 600, display: 'inline-block' }}>Voltar à busca</a>
      </div>
    </main>
  );
}
