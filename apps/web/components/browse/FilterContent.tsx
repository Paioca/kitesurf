...
const COPY = {
  pt: {
    ...
    conditionLabel: { novo_lacrado: 'Novo, lacrado', novo_10x: 'Pouco usado', semi_otimo: 'Seminovo, em ótimo estado', semi_desgaste: 'Seminovo, com sinais de uso', usado_desgaste: 'Usado, com desgaste visível', novo: 'Novo', seminovo: 'Seminovo', bom: 'Bom estado', usado: 'Usado', nova: 'Nova', seminova: 'Seminova', usada: 'Usada', com_reparos: 'Com reparos' } as Record<string, string>,
  ...
  en: {
    ...
    conditionLabel: { novo_lacrado: 'New, sealed', novo_10x: 'Lightly used', semi_otimo: 'Pre-owned, great condition', semi_desgaste: 'Pre-owned, signs of use', usado_desgaste: 'Used, visible wear', novo: 'New', seminovo: 'Pre-owned', bom: 'Good condition', usado: 'Used', nova: 'New', seminova: 'Pre-owned', usada: 'Used', com_reparos: 'With repairs' } as Record<string, string>,
