...
const sections: LegalSection[] = [
  { id: 'o-que-e', title: 'O que é a Vaya', body: 'A Vaya é uma plataforma que conecta pessoas que compram e vendem equipamento de kitesurf. A Vaya não é parte das negociações: não vende, não compra, não intermedia pagamento e não garante os itens anunciados. O negócio é feito diretamente entre comprador e vendedor.' },
  ...
  { id: 'responsa', title: 'Limitação de responsabilidade', body: 'A Vaya disponibiliza a plataforma "como está". Não nos responsabilizamos por danos, perdas ou prejuízos decorrentes de negociações entre usuários. Avalie o equipamento pessoalmente antes de fechar negócio.' },
...
export default function Termos() {
  return (
    <LegalPage
      ...
      intro="A Vaya é um marketplace que conecta pessoas que compram e vendem equipamento de kitesurf. Não somos parte da negociação, não processamos pagamento e não fazemos a entrega. Ao usar a plataforma você concorda com os termos abaixo."
      sections={sections}
