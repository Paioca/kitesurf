...
export const metadata: Metadata = {
  ...
  description:
    'Como vender equipamentos de kitesurf usados na Kitetropos: crie um anúncio com fotos e ficha técnica, telefone verificado, receba ofertas e pedidos de visita, e libere seu WhatsApp só quando quiser. Anunciar é gratuito na Fase 0.',
...
const sections: LegalSection[] = [
  {
    ...
    body: 'Fotos boas (geral, marca e modelo, etiqueta de tamanho, válvulas e bordas, e os reparos se houver) e uma ficha honesta com marca, modelo, ano, tamanho, condição, reparos, microfuros e bladder. Quanto mais claro o estado real, mais rápido vem o comprador certo.',
  },
  {
...
export default function VenderKiteUsado() {
  return (
    <LegalPage
      ...
      intro="Anuncie seu equipamento de kitesurf com menos conversa perdida. Na Kitetropos você cria um anúncio estruturado, mantém o telefone verificado e libera o WhatsApp só quando o interesse é real."
      sections={sections}
      contact={
        <>
