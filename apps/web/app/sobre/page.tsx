...
export const metadata: Metadata = {
  ...
  description:
    'A Kitetropos é um marketplace brasileiro de kite e barra usados, nascido em Cumbuco. Conecta vendedores e compradores com telefone verificado, anúncios estruturados e contato pelo WhatsApp.',
...
const sections: LegalSection[] = [
  ...
  },
  {
    id: 'para-quem',
    title: 'Para quem é',
    body: 'Para a comunidade de kitesurf no Brasil: quem quer vender um kite ou barra sem ruído, e quem quer comprar equipamento usado com mais informação e menos risco. De Cumbuco para todos os spots.',
  },
];
...
export default function Sobre() {
  return (
    <LegalPage
      ...
      intro="A Kitetropos é um marketplace brasileiro de kite e barra usados, nascido em Cumbuco. Conecta quem vende e quem compra equipamento de kitesurf com mais contexto, telefone verificado e contato direto pelo WhatsApp."
      sections={sections}
      contact={
        <>
