...
const sections: LegalSection[] = [
  ...
  { id: 'publico', title: 'O que é público', body: <>Nome, foto, spot de interesse e nacionalidade, seus anúncios ativos e suas avaliações. <strong>Telefone e e-mail nunca são exibidos publicamente</strong>. Só aparece o selo de "verificado".</> },
